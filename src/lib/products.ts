...
export const insuranceCompanies = [
  ...
  { name: "Madgeburger Sigorta", logo: "/images/madgeburger(2).webp" },
  { name: "Mapfre", logo: "/images/mapfre(2).webp" },
  { name: "Ray Sigorta", logo: "/images/ray(2).webp" },
  { name: "Doğa Sigorta", logo: "/images/doga(2).webp" },
  { name: "Demir Sigorta", logo: "/images/demir(2).webp" },
  { name: "Bereket Sigorta", logo: "/images/bereket(2).webp" },
  { name: "AXA", logo: "/images/axa(3).webp" },
  { name: "Aveon", logo: "/images/aveon(2).webp" },
  { name: "Allianz", logo: "/images/allianz(2).webp" },
  { name: "Ak Sigorta", logo: "/images/ak(2).webp" },
  { name: "Sompo", logo: "/images/sompo(2).webp" },
  { name: "Türkiye Sigorta", logo: "/images/turkiye-sigorta.webp" },
  { name: "Türk Nippon", logo: "/images/turk-nippon(2).webp" },
  { name: "Anadolu Sigorta", logo: "/images/anadolu(2).webp" },
  { name: "Quick Sigorta", logo: "/images/quick-1.webp" },
];
